...
exports.CreateMigrations1739977485686 = void 0;
class CreateMigrations1739977485686 {
    constructor() {
        this.name = 'CreateMigrations1739977485686';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`basket_products_product\` (\`basketId\` int NOT NULL, \`productId\` int NOT NULL, INDEX \`IDX_8e4e11d122c1adbfdcbf232caf\` (\`basketId\`), INDEX \`IDX_7803cda88d93f006ea628b086d\` (\`productId\`), PRIMARY KEY (\`basketId\`, \`productId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`basket_products_product\` ADD CONSTRAINT \`FK_8e4e11d122c1adbfdcbf232caf7\` FOREIGN KEY (\`basketId\`) REFERENCES \`basket\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`basket_products_product\` ADD CONSTRAINT \`FK_7803cda88d93f006ea628b086dc\` FOREIGN KEY (\`productId\`) REFERENCES \`product\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`basket_products_product\` DROP FOREIGN KEY \`FK_7803cda88d93f006ea628b086dc\``);
        await queryRunner.query(`ALTER TABLE \`basket_products_product\` DROP FOREIGN KEY \`FK_8e4e11d122c1adbfdcbf232caf7\``);
        await queryRunner.query(`ALTER TABLE \`basket\` DROP FOREIGN KEY \`FK_26dcb999420495bb5b14a4f8d1c\``);
        await queryRunner.query(`ALTER TABLE \`product\` DROP FOREIGN KEY \`FK_ff0c0301a95e517153df97f6812\``);
        await queryRunner.query(`DROP INDEX \`IDX_7803cda88d93f006ea628b086d\` ON \`basket_products_product\``);
        await queryRunner.query(`DROP INDEX \`IDX_8e4e11d122c1adbfdcbf232caf\` ON \`basket_products_product\``);
        await queryRunner.query(`DROP TABLE \`basket_products_product\``);
...
exports.CreateMigrations1739977485686 = CreateMigrations1739977485686;
//# sourceMappingURL=1739977485686-CreateMigrations.js.map